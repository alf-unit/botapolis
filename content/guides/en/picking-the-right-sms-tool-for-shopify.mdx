...
- **Primary channel + <50k segments/year + any email**: Klaviyo SMS add-on (if you're on Klaviyo) or Postscript Starter (otherwise)
...
- **New Shopify store, <500 SMS-eligible subscribers**: Omnisend free tier with bundled SMS. Wait until 1,500-2,000 subscribers before reconsidering.
