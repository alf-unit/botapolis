...
Place a test order via your Shopify store, then immediately check the customer profile in Mailchimp. Klaviyo: order visible in under 30 seconds. Omnisend: under 60 seconds. Mailchimp: typically 5-15 minutes (batch sync). For automations triggered on purchase, this lag matters.
</Callout>
