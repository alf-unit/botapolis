...
description: "Triple Whale's Free tier covers Triple Pixel + 12-month lookback genuinely. Paid plans run $179 Starter / $259 Advanced / $539+ Custom — but real cost scales with GMV. The Moby 2 AI agent, attribution accuracy concerns, and 12-month commitment. Verified 2026-06-03."
...
- **Avoid if:** Pre-revenue or tiny brands without paid-media spend; multi-platform sellers >20% off-Shopify revenue (Triple Whale is Shopify-first); teams unwilling to act on the data.
...
- **Multi-platform sellers with >20% off-Shopify revenue.** Triple Whale is Shopify-first. Brands selling 25%+ on Amazon + 30%+ on direct + 45% Shopify get fragmented attribution. Polar Analytics ([see Polar pricing analysis](/tools/polar-analytics)) handles multi-platform better.
...
- **Skip if:** Pre-revenue, multi-platform with >20% off-Shopify, or teams not acting on data.
