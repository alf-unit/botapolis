...
**Сайт инженерно готов, отполирован, забэкаплен, локализован end-to-end, выровнен по дизайну v.026. Инженерное ТЗ закрыто. Sprint 2 + Blocks A–F + 4 волны live-аудита + i18n+UX + полный дизайн-аудит май 2026 (Wave 1-5). Прод на `https://botapolis.com` стабильный. Дальше — operational phase (контент + monitoring), не engineering.**
...
8. **НЕ трогай locked items** (см. перечень в секции «Дизайн-аудит май 2026 → Стартовая разведка»): CTA shimmer, NavbarSearch + /search, LanguageSwitcher, NewsletterDialog.
