...
- **Klaviyo** ([review](/reviews/klaviyo)) — past $30k MRR; segmentation depth pays back
- **Omnisend** ([review](/reviews/omnisend)) — sub-$50k MRR; bundled SMS + email is cheaper
- **Mailchimp** ([review](/reviews/mailchimp)) — only for first store, sub-500 subscribers
