...
- **Loop Subscriptions** at any band under $200K MRR — $99/mo Starter + 1.00% transaction fee + NO per-order flat fee. Material savings at high order volume. See [Loop Subscriptions review](/tools/loop-subscriptions) and the [Recharge vs Loop comparison](/compare/loop-subscriptions-vs-recharge).
