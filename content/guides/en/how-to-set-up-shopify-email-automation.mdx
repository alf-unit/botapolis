...
- **Don't trigger on every product view** — fire only on PDPs viewed for over 15 seconds (filter out bounce sessions)
...
- **Klaviyo** ([review](/tools/klaviyo)) — past $30k MRR; segmentation depth pays back
- **Omnisend** ([review](/tools/omnisend)) — sub-$50k MRR; bundled SMS + email is cheaper
- **Mailchimp** ([review](/tools/mailchimp)) — only for first store, sub-500 subscribers
