...
export default async function GuidesIndexPage() {
  ...
  // Load frontmatter for the active locale. RU guides have all been
  // generated by the husky pre-commit hook (or written manually), so
  // matching the locale gives RU users actual Russian titles + descriptions
  // instead of the English originals the page was hardcoded to before.
  // If a specific slug has no RU twin, getAllMdxFrontmatter just omits it
  // from the list (the loader returns [] for a missing dir, and skips
  // unreadable files); the per-article page at /ru/guides/[slug] still
  // has its own EN fallback inside getMdxContent.
  const guides = await getAllMdxFrontmatter("guides", locale)
